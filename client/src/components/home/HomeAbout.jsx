...
const HomeAbout = () => {
  return (
    <div className='mt-10  '>
        <h1 className='text-4xl md:text-5xl font-bold mb-4 leading-tight text-param-blue text-center'>About Us</h1>
        ...
        <div className='w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left p-4'>
          ...
          <h1 className='text-3xl md:text-4xl font-bold mb-6 leading-tight text-param-blue'>
            Crafting Comfort, Delivering Quality.
          </h1>

          {/* Descriptive paragraph */}
          <p className='text-lg md:text-xl text-param-blue leading-relaxed mb-8'>
          ...
          <div className=''>
            <Link to="/about">
            <button  className='bg-param-gold text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-gray-800 transition duration-300'>
              Learn More About Us
            </button>
            </Link>
          </div>
        ...
        <div className='w-full lg:w-1/3 p-4 flex justify-center lg:justify-start'>
          <img
            src="https://placehold.co/600x400/1A3B6A/FFFFFF?text=Param+Index+T-Shirts" // Placeholder image: Replace with your actual image URL
